...
def predict_onecase(infile_A, infile_B, outdir, model=None):
    ...
    sitk.WriteImage(out_img_B, os.path.join(outdir, '2835191_use_3911806_fake_B.nii.gz'))
    sitk.WriteImage(in_img_A, os.path.join(outdir, '2835191_use_3911806_real_A.nii.gz'))
    sitk.WriteImage(in_img_B, os.path.join(outdir, '2835191_use_3911806_real_B.nii.gz'))
